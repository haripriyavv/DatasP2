...
sky_cover = st.number_input("Sky Cover",min_value=0)
visibility = st.number_input("Visibility",min_value=0)
humidity = st.number_input("Humidity",min_value=0)
avg_wind_speed = st.number_input("Average Wind Speed (Period)",min_value=0)
avg_pressure = st.number_input("Average Pressure (Period)",min_value=0)
